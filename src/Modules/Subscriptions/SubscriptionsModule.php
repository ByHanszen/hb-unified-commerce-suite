...
JS;
    ...
    public function render_purchase_options(): void {
        ...
        echo '<div class="hb-ucs-subscriptions hb-ucs-subscriptions--product hb-ucs-subscriptions--swatches' . ($subscriptionChosen ? ' is-subscription-selected' : '') . '" data-default-scheme="' . esc_attr($defaultScheme) . '">';
        ...
        echo '<select id="' . esc_attr($modeFieldId) . '" class="hb-ucs-subscriptions__mode-select hb-ucs-subscriptions__mode-select--hidden" name="' . esc_attr($modeFieldName) . '" aria-hidden="true" tabindex="-1">';
        ...
        echo '</select>';
        echo '<ul class="hb-ucs-subscriptions__mode-swatches wvs-style-rounded" role="radiogroup" aria-label="' . esc_attr__('Kies aankooptype', 'hb-ucs') . '">';
        echo '<li class="hb-ucs-subscriptions__mode-swatch' . ($subscriptionChosen ? '' : ' selected') . '" data-mode-value="single" title="' . esc_attr__('Eenmalige aankoop', 'hb-ucs') . '" data-title="' . esc_attr__('Eenmalige aankoop', 'hb-ucs') . '" role="radio" tabindex="' . ($subscriptionChosen ? '-1' : '0') . '" aria-checked="' . ($subscriptionChosen ? 'false' : 'true') . '" aria-disabled="false">';
        echo '<div class="hb-ucs-subscriptions__mode-swatch-contents variable-item-contents">';
        echo '<span class="hb-ucs-subscriptions__mode-swatch-label variable-item-span variable-item-span-button">' . esc_html__('Eenmalige aankoop', 'hb-ucs') . '</span>';
        echo '</div>';
        echo '</li>';
        echo '<li class="hb-ucs-subscriptions__mode-swatch' . ($subscriptionChosen ? ' selected' : '') . '" data-mode-value="subscription" title="' . esc_attr__('Abonnement', 'hb-ucs') . '" data-title="' . esc_attr__('Abonnement', 'hb-ucs') . '" role="radio" tabindex="' . ($subscriptionChosen ? '0' : '-1') . '" aria-checked="' . ($subscriptionChosen ? 'true' : 'false') . '" aria-disabled="false">';
        echo '<div class="hb-ucs-subscriptions__mode-swatch-contents variable-item-contents">';
        echo '<span class="hb-ucs-subscriptions__mode-swatch-label variable-item-span variable-item-span-button">' . esc_html__('Abonnement', 'hb-ucs') . '</span>';
        echo '</div>';
        echo '</li>';
        echo '</ul>';
